...
from schemas import ReturnUserSchema, SuccessSchema
...
@route_us.get("/me", status_code=status.HTTP_200_OK, response_model=ReturnUserSchema)
async def user_info(
...
@route_us.get(
    "/{user_id}", status_code=status.HTTP_200_OK, response_model=ReturnUserSchema
)
...
@route_us.delete(
    "/{user_id}/follow", status_code=status.HTTP_200_OK, response_model=SuccessSchema
)
